 ...
 *
 * @ViewsField("orgx_ref_contribcat")
 */
class OrgxRefContribcat extends FieldPluginBase {
  ...
  public function query() {
    if ( $this->view->id() === 'contributor_orgx'  ||  $this->view->id() === 'yse_user_functions') {
      ...
      $this->query->addField($author_table_alias, 'author_category', 'orgx_ref_contribcat');
    }
  }
  ...
  public function render(ResultRow $values) {
    ...
    $outval = $values->orgx_ref_contribcat;
    return $outval;
  }
